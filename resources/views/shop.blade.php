...
<main class="pt-90">
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
            <a href="{{route('home.indexx')}}" class="menu-link menu-link_us-s text-uppercase fw-medium">Home</a>
            <span class="breadcrumb-separator menu-link fw-medium ps-1 pe-1">/</span>
            <a href="{{route('shop.indexx')}}" class="menu-link menu-link_us-s text-uppercase fw-medium">The Shop</a>
          </div>
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items"
              ...
              <option value="4" {{$order ==4 ?'selected':''}}>Price,highto low</option>
                  ...
                  <div class="pc__img-wrapper">
                    <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                          <a href="{{route('shop.products.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{asset('uploads/products/'.$product->image)}}"
  ...
  <form action="{{route('shop.indexx')}}" method="GET" id="frmfilter">
...
<script>
    $("#pagesize").on("change", function(){
        // Soit ajouter id="size" dans votre input caché,
        // soit utiliser un sélecteur par attribut, par exemple:
        $("input[name='size']").val($("#pagesize option:selected").val());
        $("#frmfilter").submit(); // id en minuscule
    });
